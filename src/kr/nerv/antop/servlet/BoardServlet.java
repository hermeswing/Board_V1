...
public class BoardServlet {
    ...
    public ModelAndView view( ModelAndView mav, HttpServletRequest request, HttpServletResponse response,
            @RequestParam( required = false ) Integer page, @RequestParam( value = "bid" ) int boardId,
            @RequestParam( required = false ) String search ) {
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("page", page);
        map.put("search", search);
    ...
    public ModelAndView delete( ModelAndView mav, HttpServletRequest request, @RequestParam( value = "bid" ) Integer boardId,
    ...
    public ModelAndView form( HttpServletRequest request, HttpServletResponse response, ModelAndView mav,
            @RequestParam String query, @RequestParam( defaultValue = "1" ) int page,
            @RequestParam( required = false ) String search, @RequestParam( value = "bid", required = false ) Integer boardId ) {
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("query", query);
        map.put("page", page);
        map.put("search", search);
    ...
    public ModelAndView proc( ModelAndView mav, @RequestParam String query,
            @RequestParam( required = false, value = "bid" ) Integer boardId, @RequestParam String subject,
            @RequestParam String author, @RequestParam String pwd, @RequestParam( required = false ) String newPwd,
            @RequestParam( required = false ) Boolean security, @RequestParam( required = false ) String content,
    ...
    public ModelAndView auth( HttpServletRequest request, HttpServletResponse repsonse, ModelAndView mav,
            @RequestParam( value = "board_id" ) Integer boardId, @RequestParam String pwd,
